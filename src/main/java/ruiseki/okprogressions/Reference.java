...
public class Reference {
    ...
    public static final String DEPENDENCIES = "required-after:gtnhlib@[0.11.21,);"
        ...
        + "required-after:okcore@[26.07.06.1,);"
        + "after:Baubles|Expanded;"
        + "after:Baubles;"
        + "after:NotEnoughItems;"
        + "after:Waila;";
    public static final String UPDATE_URL = "https://raw.githubusercontent.com/Shigure-Ruiseki/OKProgressions/master/version/version.json";
